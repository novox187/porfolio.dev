...
}, "/workspaces/porfolio.dev/src/components/Badge.astro", void 0);
...
}, "/workspaces/porfolio.dev/src/components/SectionContainer.astro", void 0);
...
}, "/workspaces/porfolio.dev/src/components/icons/Sun.astro", void 0);
...
}, "/workspaces/porfolio.dev/src/components/icons/Moon.astro", void 0);
...
}, "/workspaces/porfolio.dev/src/components/icons/System.astro", void 0);
...
}, "/workspaces/porfolio.dev/src/components/ThemeToggle.astro", "self");
...
const $$Header = createComponent(($$result, $$props, $$slots) => {
  const navItems = [
    ...
    },
    {
      title: "Contacto",
      label: "contacto",
      url: "https://t.me/HARRISONO_O"
    }
  ];
  return renderTemplate`${maybeRenderHead()}<header class="fixed top-0 z-10 flex items-center justify-center w-full mx-auto mt-2" data-astro-cid-3ef6ksr2> <nav class="flex px-3 text-sm font-medium rounded-full text-gray-600 dark:text-gray-200 justify-center items-center" data-astro-cid-3ef6ksr2> ${navItems.map((link) => renderTemplate`<a class="relative block px-2 py-2 transition hover:text-blue-500 dark:hover:text-blue-500"${addAttribute(link.label, "aria-label")}${addAttribute(link.url, "href")} target="_blank" data-astro-cid-3ef6ksr2> ${link.title} </a>`)} ${renderComponent($$result, "ThemeToggle", $$ThemeToggle, { "data-astro-cid-3ef6ksr2": true })} </nav> </header> ${renderScript($$result, "/workspaces/porfolio.dev/src/components/Header.astro?astro&type=script&index=0&lang.ts")} `;
}, "/workspaces/porfolio.dev/src/components/Header.astro", void 0);

const $$Footer = createComponent(($$result, $$props, $$slots) => {
  (/* @__PURE__ */ new Date()).getFullYear();
  return renderTemplate`${maybeRenderHead()}<footer class="opacity-80 m-4 min-[375px]:pl-4 md:pl-0 mt-16 w-full mx-auto container lg:max-w-4xl md:max-w-2xl mb-10 flex justify-center"> <div class="rounded-lg w-full max-w-screen-xl mx-auto md:flex md:items-center md:justify-between py-4"> Gracias por pasarte por mi portafolio ❤
<ul class="flex flex-wrap items-center mt-3 text-sm font-medium dark:text-white/90 sm:mt-0"> <li> <a href="/#sobre-mi" class="hover:underline me-4 md:me-6">Sobre mí</a> </li> <li> <a id="contacto" href="https://t.me/HARRISONO_O" target="_blank" class="hover:underline">Contacto</a> </li> </ul> </div> </footer>`;
}, "/workspaces/porfolio.dev/src/components/Footer.astro", void 0);
...
const $$ClientRouter = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<meta name="astro-view-transitions-enabled" content="true"><meta name="astro-view-transitions-fallback"${addAttribute(fallback, "content")}>${renderScript($$result, "/workspaces/porfolio.dev/node_modules/.pnpm/astro@5.13.10_@types+node@24.5.2_@vercel+functions@2.2.13_jiti@1.21.7_rollup@4.52.0_typescript@5.3.3_yaml@2.8.1/node_modules/astro/components/ClientRouter.astro?astro&type=script&index=0&lang.ts")}`;
}, "/workspaces/porfolio.dev/node_modules/.pnpm/astro@5.13.10_@types+node@24.5.2_@vercel+functions@2.2.13_jiti@1.21.7_rollup@4.52.0_typescript@5.3.3_yaml@2.8.1/node_modules/astro/components/ClientRouter.astro", void 0);
...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="es"> <head><meta charset="UTF-8"><meta name="description"${addAttribute(description, "content")}><meta name="viewport" content="width=device-width"><link rel="icon" type="image/svg+xml" href="/favicon.svg"><meta name="author" content="Harrison Ochoa"><meta name="keywords" content="Harrison, Ochoa, Desarrollador, Web, Portafolio, Portfolio, Developer, Frontend, Backend, Fullstack"><meta name="theme-color" content="#ffffff"><meta name="apple-mobile-web-app-capable" content="yes"><meta name="apple-mobile-web-app-status-bar-style" content="black-translucent"><link rel="apple-touch-icon" href="/apple-touch-icon.png"><link rel="preload" as="font" href="/fonts/Onest-Variable.woff2" type="font/woff2" crossorigin="anonymous"><meta name="generator"${addAttribute(Astro2.generator, "content")}><title>${title}</title>${renderComponent($$result, "ViewTransitions", $$ClientRouter, {})}${renderHead()}</head> <body class="relative text-black dark:text-white"> <div class="absolute top-0 bottom-0 z-[-2] min-h-screen w-full min-w-screen bg-gray-50 dark:bg-gray-950
...
}, "/workspaces/porfolio.dev/src/layouts/Layout.astro", void 0);

export { $$Layout as $, $$SectionContainer as a, $$Badge as b };
